  ...
  return (
    <div className="sidebar">
      ...
      <div className="sidebar-content">
        ...
        <div className="sidebar-section">
          <div className="sidebar-section-header">
            ...
            <div style={{ display: 'flex', gap: '4px' }}>
              <button onClick={handleBrowseChannels} title="Browse Channels" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
              </button>
              <button onClick={() => setShowCreateChannel(true)} title="Create Channel" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div className="sidebar-section">
          <div className="sidebar-section-header">
            ...
            <button onClick={() => setShowNewDM(true)} title="New Message" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div className="sidebar-user">
        ...
        <button className="btn-icon" onClick={logout} title="Logout" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-tertiary)' }}>
